...
test_part1 = solution("../sample.txt", 2022)
assert test_part1 == 3068, test_part1
print("Ok")
print(f"Part 1 => {solution('../input.txt', 2022)}")

test_part2 = solution("../sample.txt", 1000000000000)
assert test_part1 == 1514285714288, test_part2
print("Ok")
print(f"Part 2 => {solution('../input.txt', 1000000000000)}")
